...
hero_link: https://rpubs.com/jeanettejohnson/1018399
...
3 . To ensure CoGAPS is working properly, we will first load in the simulated toy data for a test run. Single-cell data will be loaded later in <a href="/CoGAPSGuide/proceduretwo/#running-cogaps-on-single-cell-data">step 6</a>.
...
<a href="/CoGAPSGuide/troubleshooting/#procedure-2" target="_blank">TROUBLESHOOTING</a>
</p>
